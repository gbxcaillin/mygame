// Snapshot of the card stats (image-free) so the bot bundle stays tiny and
// plays with the exact same ranks as the game — no board divergence.
// Generated from src/game/cards.ts; regenerate if card stats ever change.
import type { Card, Rarity } from "../src/game/types";

interface CreatureData {
  name: string; rarity: Rarity; tier: number;
